...
namespace MvcApplication1.Models.GrainSimple
{
    public class VisCalculation
    {
        ...
        public PaletteType ProcessImage(VisionImage image)
        {
            ...
            vaClassifierReportsSize = IVA_ClassifySize(image, roi, vaClassifierFilePathSize);
            VisGrainSizeCollection colSize = new VisGrainSizeCollection(vaClassifierReportsSize);

            GrainResults = new VisGrainDataCollection(vaClassifierReports, vaClassifierReportsSize, ListShape);
